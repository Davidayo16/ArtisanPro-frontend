...
import ArtisanHeader from "../components/dashboard/ArtisanHeader";
import { X } from "lucide-react";

export default function ArtisanDashboardLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar - Desktop */}
        <ArtisanSidebar collapsed={sidebarCollapsed} />
        ...
        >
          <div className="p-4 sm:p-6 lg:p-8 mt-16 min-h-screen max-w-full">
            <div className="animate-fadeIn max-w-full">{children}</div>
          </div>
        </main>
      </div>
